...
useHead({
  title: "KQ Pumps :: ВОДОСНАБЖЕНИЕ И ПОВЫШЕНИЕ ДАВЛЕНИЯ",
  meta: [
    {
      name: `description`,
...
const dummyTitle = "ВОДОСНАБЖЕНИЕ И ПОВЫШЕНИЕ ДАВЛЕНИЯ";
</script>
  ...
  <div class="2xl:px-10 xl:px-8 lg:px-6 px-4">
    <Breadcrumbs
      :current="[
        ...
        {
          title: dummyTitle.split(' ').slice(0, 4).join(' ') + '...',
        },
      ]"
    />
